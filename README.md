# nvim-treesitter-queries-gdshader

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gdshader/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gdshader/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gdshader**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gdshader",
...
- [ ] Changes are scoped to `gdshader` — do not include files for other languages
